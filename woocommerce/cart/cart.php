...
<section class="katalog cart_page_title">
    <div class="container">
		...
		<?php endif; ?>
		<?php $aditional_text = get_field('text_in_top_right_corner', 'option'); ?>
		<?php if($aditional_text): ?>
			<div class="shipping_price_block">
				<div class="shipping_price">
					<?php echo $aditional_text; ?>	
				</div>
			</div>
		<?php endif; ?>
	</div>
						...
						<td class="product-remove">
							...
							<?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><div class="trash_icon"></div>&times;</a>',
