...
<a href="<?php echo  get_home_url() . '/shop/' ?>" class="popularity first filter-list-item">за популярністю</a>
<?php foreach ( $catalog_orderby_options as $id => $name ) : ?>
...
<?php endforeach; ?>
<a href="<?php echo  get_home_url() . '/shop/?orderby=title&paged=1' ?>" class="title filter-list-item">за алфавітом</a>
